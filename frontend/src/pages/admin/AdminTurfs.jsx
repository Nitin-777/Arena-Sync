...
export default function AdminTurfs() {
  ...
  const fetchTurfs = useCallback(async () => {
    try {
      setLoading(true)
      const res = await adminGetAllTurfs()
  ...
  return (
    <div className="p-8">
      ...
      {/* SEARCH */}
      <div
        className="flex items-center gap-2 px-3 rounded-xl mb-5 max-w-xs"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2, 3, 4].map(i => (
            <div
              ...
              style={{ background: '#E8E8E4', height: 160 }}
            />
          ))}
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3 mb-5">
                <div className="flex-1 min-w-0">
                  <h3 className="truncate" style={{ fontSize: 15, fontWeight: 700 }}>
                    {turf.name}
                  </h3>

                  <p className="truncate" style={{ fontSize: 12, color: '#999' }}>
                    {turf.address}
                  </p>
                ...
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${
                      turf.status === 'active' ? '#bbf7d0' : '#fecaca'
                    }`,
                ...
                >
                  <span
                    ...
                    style={{
                      background:
                        turf.status === 'active' ? '#22c55e' : '#ef4444',
                    }}
                  />
                  {updating === turf.id
                    ? '...'
